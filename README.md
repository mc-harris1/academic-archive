...
Academic archive scaffold for organizing post-baccalaureate work, graduate coursework, and shared language-specific resources.

## Repository Layout

- `post-bacc/`: post-baccalaureate notes and course materials
- `graduate-school/`: graduate coursework and related materials
- `shared/`: cross-program resources, utilities, and reference notes
